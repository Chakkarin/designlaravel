...
<head>
    ...
    <title>ระบบจัดการข้อมูลสำหรับหญิงฝากครรภ์</title>
...
<div class="navbar navbar-default navbar-fixed-top" role="navigation">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{asset('antenatal')}}">ระบบจัดการข้อมูลสำหรับหญิงฝากครรภ์</a>
        </div>
        <div class="navbar-collapse collapse navbar-right">
            <ul class="nav navbar-nav">
                <li><a href="{{asset('antenatal/infoBaby')}}">ข้อมูลประวัติลูก</a></li>
                <li class="dropdown">
