...
@section('content')
    <div id="blue">
        <div class="container">
            <div class="row">
                <h3>รายงานประเมินความเจริญเติบโต และสรุปการนับความถี่ของเด็ก</h3>
            </div><!-- /row -->
        </div> <!-- /container -->
    </div><!-- /blue -->
    ...
    <div class="container mtb">
        <div class="container">
            <h4>ค้นหา</h4>
                <div class="hline col-md-4"></div>
                <div class="clearfix"></div>
             <p class="col-md-4">
                <br>
            <input type="text" class="form-control " placeholder="ค้นหาจากปี">
             </p>
        </div>
        <br>
        <div class="container">
        ...
        <div class="clearfix"></div>
            <div class="container panel">
                <div class="form-group col-md-12 ">
                     <label for="message1">สรุปผล</label>
