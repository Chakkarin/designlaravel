...
@section('content')
    <div id="blue">
        <div class="container">
            <div class="row">
                <h3>ข้อมูลการเจริญเติบโตของเด็ก น้ำหนักตามเกณฑ์อายุ</h3>
            </div><!-- /row -->
        </div> <!-- /container -->
    </div><!-- /blue -->
            ...
            <div class="col-md-12" style="overflow-x:auto;">
                <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%" >
                    ...
                    <tr>
                        ...
                        <td>นามสกุล</td>
                        <td>นามสกุล</td>
                        <td><a href="{{asset('officer/report/chart3')}}" class="btn btn-warning"><i class="fa fa-area-chart" aria-hidden="true"></i></a></td>
